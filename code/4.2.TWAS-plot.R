...
twas$P0<-NULL
twas$P1<-NULL
pos<-data.frame(fread("/mnt/e/soft/fusion_twas-master/reference/GTExv8.ALL/CMC.BRAIN.RNASEQ2.pos"))
...
ref<-data.frame(fread("/mnt/e/soft/fusion_twas-master/glist-hg19"))
...
joint<-data.frame(fread(paste0("/mnt/e/project/ADHD/FUSION/result/Joint-conditional-tests/ADHD_clean.GW.Sig.1",'.joint_included.dat')),Joint=T)
n_line<-system(paste0('wc -l ',"/mnt/e/project/ADHD/FUSION/result/Joint-conditional-tests/ADHD_clean.GW.Sig.1",'.joint_dropped.dat'),intern=T)
n_line<-as.numeric(unlist(strsplit(n_line,' '))[1])
if(n_line > 1){
  dropped<-data.frame(fread(paste0("/mnt/e/project/ADHD/FUSION/result/Joint-conditional-tests/ADHD_clean.GW.Sig.1",'.joint_dropped.dat')),Joint=F)
} else {
  dropped<-NULL
}
...
post_proc_file<-sub(".*/", '', "/mnt/e/project/ADHD/FUSION/result/Joint-conditional-tests/ADHD_clean.GW.Sig.1")
post_proc_dir<-sub(paste0('/',post_proc_file), '', "/mnt/e/project/ADHD/FUSION/result/Joint-conditional-tests/ADHD_clean.GW.Sig.1")
